  ...
  public: {
    Tables: {
      ...
      inventory_transactions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "inventory_transactions_task_id_fkey"
            columns: ["task_id"]
            isOneToOne: false
            referencedRelation: "tasks"
            referencedColumns: ["id"]
      ...
      safety_documents: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "safety_documents_site_id_fkey"
            columns: ["site_id"]
            isOneToOne: false
            referencedRelation: "sites"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "safety_documents_task_id_fkey"
            columns: ["task_id"]
            isOneToOne: false
            referencedRelation: "tasks"
            referencedColumns: ["id"]
      ...
      sites: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "sites_site_supervisor_id_fkey"
    ...
    Enums: {
      ...
      task_status:
        ...
        | "on_hold"
        | "cancelled"
      txn_type: "check_out" | "check_in" | "transfer" | "maintenance"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
